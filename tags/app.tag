<app>
    ...
    <table>
        <tr>
            <td>
                <button type="button" onclick={ changeToWork }>choose this</button>
            </td>
            <td>
                <button type="button" onclick={ changeToPlay }>or choose this</button>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <script>
        ...
        this.playOptions = [
            "Let’s watch a bunch of YouTube videos on creatures of the deep sea and then go on a YouTube spiral that takes us through Elon Musk talking about why he thinks we’re living in a computer simulation, and ends with us watching interviews with Justin Bie" +
                    "ber’s mom",
        ...
        this.addPlayAndWork = function (event) {
